...
const  ProjectBox = ({projectPhoto, projectName}) => {
  const desc = {
    ZengoDesc: "Zengo is the self-custodial wallet with no seed phrase vulnerability. Protect and manage all of your cryptocurrencies and NFTs with the crypto wallet thats secure by default. Buy, sell, trade, and send over 120+ crypto and Web3 assets, all with the power of MPC security, a secure recovery model and unparalleled 24/7 customer support.",
