  ...
  return (
    <div className="TypeEffect">
      <Typewriter
        options={{
          strings: [
            "Siphamandla Whati. Founder of Ekhaya#36 Tournament. My organistion is now known by everyone thanks to Musa, he elevated our organization into new heights.", "Daniel MabundaSenior developer fintech developer at Zengo-X
