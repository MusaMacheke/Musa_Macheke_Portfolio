    ...
    return (
        <nav className={navbarBlur ? 'Navbar blur' : 'Navbar'} data-aos="fade-down">
            ...
            <ul className={menuOpen ? 'NavbarLinks showNavbar' : 'NavbarLinks'} ref={navRef}>
                ...
                <li onClick={closeMenu}><Link to="https://drive.google.com/file/d/1SNk-SUwDyVeUDRWTOdxP6GiZeEOQeCkK/view?usp=sharing" activeClassName="active" onClick={closeMenu}><CgFileDocument aria-label="Resume" /> Resume</Link></li>
